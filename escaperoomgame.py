...
def main():
    ...
    room1 = Room(
        ...
        [
            ...
            {"question": "A clock shows the time as 3:15. What is the angle between the hour and minute hands?", "answer": "7.5 degrees"},
    ...
    room3 = Room(
        ...
        [
            ...
            {"question": "I have cities, but no houses. I have forests, but no trees. I have rivers, but no water. What am I?", "answer": "A map"},
            {"question": "Before Mt. Everest was discovered, what was the highest mountain in the world?", "answer": "Mt. Everest"},
            {"question": "What is something you sleep on, sit on and brush with?", "answer": "bed, chair, toothbrush"},
        ...
        [
            ...
            "Identify common household items for these actions.",
